...
foreach ($livros as $livro) {
    ...
    $livroObjeto->titulo = $livro['titulo'];
       $livroObjeto->autor = $livro['autor'];
       $livroObjeto->paginas = $livro['paginas'];
       $livroObjeto->sinopse = $livro['sinopse'];
       $livroObjeto->genero = $livro['genero'];
       $livroObjeto->capa = $livro['capa'];
