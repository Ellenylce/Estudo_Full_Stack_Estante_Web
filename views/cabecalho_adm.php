...
<body>
    ...
    <section class = "botton-header">
        <nav> 
            <ul>
                <li><a href="/ellen_karla/Estante-Web/views/gerenciar_livros.php">Gerenciar Livros</a></li> 
                <li><a href="/ellen_karla/Estante-Web/views/gerenciar_categorias.php">Gerenciar Categorias</a></li>
                ...
                <!-- dropdown -->
                    <div class = "drop">
                        <a href="/ellen_karla/Estante-Web/views/perfil.php">Meu Perfil</a>
                ...
                <!-- dropdown -->
                    <div class = "drop">
                        <a href="/ellen_karla/Estante-Web/views/login_adm.php">Login</a>
                        <a href="/ellen_karla/Estante-Web/views/cadastro_adm.php">Cadastro</a>
                        <a href="/ellen_karla/Estante-Web/views/perfil.php">Meu Perfil</a>
                    </div>
                <li>
                <?php endif;?> 
