        ...
        <div class ="box_gerenciar_livros">
            <div class="titulo_container">
                ...
                <div class="buttoes_vertical">
                    <button class="botoes_gerenciar_livros" type="submit">Adicionar Livro</button>
                    <button class="botoes_gerenciar_livros" type="reset">Editar Livro</button>
                </div> 
